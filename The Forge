if game.GameId ~= 7671049560 then
    warn("[Haze] ❌ Not in the correct game!")
    return
end
...
InstantForgeSection:SetDescription("⚠️ WARNING: If you use Instant Forge, you MUST quit and reopen the game before using the forge manually! ⚠️\n\nSelect ore quantities and forge instantly.")
